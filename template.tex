...
Qualitatively, this notion was identified by RB in Sec. III of \cite{10.1103/physrevd.65.016003}.  HH provided an analysis of the relationship between $a$, the cascade energy $E_{\rm C}$ and the critical energy $E_{\rm crit}$ \cite{PhysRevD.105.123019}.  Let $E_{\rm C}/E_{\rm crit} = \Lambda$.  HH found that

\begin{equation}
\frac{\sigma_{\ln\Lambda}}{\ln\Lambda} = 2\left(\frac{\sigma_a}{a}\right)
\end{equation}
\end{itemize}
