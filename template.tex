...
\section{The Amplitude of The Signal Model, $s(t)$}
\label{sec:amp}
...
\begin{equation}
s(t) = -\frac{E_0\omega_0 \sin(\theta)}{8\pi p}te^{-\frac{t^2}{4p}+p\omega_0^2}\erfc(\sqrt{p}\omega_0) \label{eq:s_full}
\end{equation}
The parameters of Eq. \ref{eq:s_full} are defined in Tab. \ref{tab:param}.
\begin{table*}
\small
\begin{tabular}{| c | c | c | c |} \hline
\textbf{Variable} & \textbf{Definition} & \textbf{Units} & \textbf{Typical Value}\\ \hline
$c$ & speed of light & meter GHz & 0.299792458 \\ 
$\theta_{\rm C}$ & Cherenkov angle & radians & 0.9739 \\ 
$\theta$ & viewing angle from cascade axis & radians & $|\theta-\theta_{\rm C}| = \mathcal{O}(1)$ degree \\ 
$a$ & longitudinal length of cascade (see \cite{10.1103/physrevd.65.016003}) & meter & $\approx 4.2$ at $\approx 10^{16}$ eV \\ 
$n_{max}$ & peak excess charged cascade particles (see \cite{10.1103/physrevd.65.016003})  & none & $\mathcal{O}(10^6)$ at $\approx 10^{16}$ eV \\
$E_{\rm 0}$ & $\propto n_{\rm max}a$ (see \cite{10.1103/physrevd.65.016003}) & V m$^{-1}$ GHz$^{-2}$ & $\approx 1.2$ at $\approx 10^{16}$ eV \\
$p$ & $\frac{1}{2}(a/c)^2 \left(\cos\theta - \cos\theta_C\right)^2$ (see \cite{PhysRevD.105.123019}) & ns$^2$ & depends on $\theta$, $\sqrt{2 p} \approx$ 1 ns \\ 
$\omega_{\rm 0}$ & $\sqrt{\frac{2}{3}} (c\sqrt{2\pi}\rho_{\rm 0})/(n\sin\theta)$ (see \cite{10.1016/j.astropartphys.2017.03.008}) & GHz & depends on $\theta$, $\omega_0/(2\pi)$ is $\mathcal{O}(1)$ GHz \\
$\sqrt{2\pi}\rho_{\rm 0}$ & lateral ICD width (see \cite{10.1016/j.astropartphys.2017.03.008}) & m$^{-1}$ & $\approx 20$ m$^{-1}$ at $\approx 10^{17}$ eV \\
$n$ & index of refraction, ice & none & $1.778 \pm 0.006$ for RF bandwidth \\ \hline
\end{tabular}
