...
\end{align}
However, approximating $I(x,z_0) \approx I(x,0)$ drops the dependance on $\gamma$ and $f_0$.
\item To solve Eq. \ref{eq:end2}, the integral function is expanded in powers of $z_0$.  This is wise, given that the UHE-$\nu$ signal bandwidth will usually exceed that of a dipole receiver with response $r(t)$ and analytic signal $r_a(t)$.
\end{itemize}
