...
\begin{abstract}
The detection of cosmogenic and astrophysical neutrinos with energies greater than 10 PeV has been a long-time goal of the astroparticle physics community.  Due to the small flux of such particles, a key strategy has been to deploy autonomous, radio-frequency (RF) detetectors in polar regions that rely on the Askaryan effect for the neutrino signal.  The Askaryan effect occurs when the excess negative charge within a high-energy cascade radiates in a dense medium.  Neutrinos with energies greater than 10 PeV can induce cascades that radiate in the radio-frequency (RF) bandwidth.  To identify neutrino signals in future data from autonomous RF detectors, mathematical models of the Askaryan electromagnetic field have been created and compared to simulations and laboratory measurements.  In the past, mathematical models have only described the Askaryan electromagnetic field, leaving the effect of the RF detection channels on the observed waveforms to simulation packages (NuRadioMC).  In this work, we present a fully analytic model that accounts for the effect of an RF detection channel.  We provide a formula for the observed voltage trace, and a formula for the Hilbert envelope of the trace.  We compare our models to traces and envelopes recorded from large-scale simulations of Askaryan-class neutrino detectors (NuRadioMC).  Our equations match NuRadioMC with correlation coefficients greater than 0.95, and power differences of less than 5\%.
\end{abstract}
