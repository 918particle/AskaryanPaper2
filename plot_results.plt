...
set origin 0,0
set size 1,1
set label 1 "f_0: 0.30 GHz, {/Symbol g}: 0.05 GHz, {/Symbol s}_t: 0.5 ns" at 16,145 font "Courier,12"
set label 2 "R_0 = 1 m ns^{-1}, E_0 = 1 V m^{-1} ns^{-1}" at 16,115 font "Courier,12"
