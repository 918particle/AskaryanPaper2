...
plot "results_July3rd_2.dat" using 1:2 w l ls 1 title "mathematical convolution", \
"results_July3rd_2.dat" using 1:3 w l ls 3 title "envelope of mathematical convolution", \
"results_July3rd_2.dat" using 1:4 w l ls 2 title "mathematical envelope"
set origin 0.4,0.1
set size 0.55,0.45
set xrange [-5:20]
set yrange [-1000:1000]
