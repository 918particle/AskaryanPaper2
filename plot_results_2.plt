...
set origin 0,0
set size 1,1
set label 1 "f_0: 0.15 GHz, {/Symbol g}: 0.033 GHz, {/Symbol s}_t: 1.0 ns" at 16,485 font "Courier,12"
set label 2 "R_0 = 1 m ns^{-1}, E_0 = 1 V m^{-1} ns^{-1}" at 16,385 font "Courier,12"
